                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                            <button @click='openEdit(<?php echo json_encode($cat, 15, 512) ?>)' class="text-yellow-600 hover:text-yellow-900 bg-yellow-100 p-2 rounded-lg transition">
                                <i class="bi bi-pencil"></i>
                            </button>
                            <form action="<?php echo e(route('categories.destroy', $cat->id)); ?>" method="POST" class="inline" onsubmit="return confirm('Hapus kategori ini?')">
                                <?php echo csrf_field(); ?>
    ...
    <div x-show="openModal" class="fixed inset-0 z-50 overflow-y-auto" x-cloak>
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="openModal" 
                ...
                <form :action="editMode ? '/categories/' + category.id : '<?php echo e(route('categories.store')); ?>'" method="POST">
                    <?php echo csrf_field(); ?>
