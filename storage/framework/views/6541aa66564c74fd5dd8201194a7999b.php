        ...
        <table class="table table-striped mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="badge bg-secondary"><?php echo e(strtoupper($user->role)); ?></span></td>
                    <td><?php echo e($user->created_at); ?></td>
                    <td class="text-end">
                        <button class="btn btn-sm btn-warning" onclick='editUser(<?php echo json_encode($user, 15, 512) ?>)' data-bs-toggle="modal" data-bs-target="#editUserModal">
                            <i class="bi bi-pencil"></i>
                        </button>
                        <form action="<?php echo e(route('users.destroy', $user->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Hapus user ini?')">
                            <?php echo csrf_field(); ?>
