    ...
    <div class="card-body p-0 table-responsive">
        <table class="table table-striped mb-0">
            ...
            <tbody>
                ...
                <tr>
                    <td><code><?php echo e($w->code); ?></code></td>
                    <td><?php echo e($w->name); ?></td>
                    <td><?php echo e($w->address ?: '-'); ?></td>
                    <td><small><?php echo e($w->description ?: '-'); ?></small></td>
                    <?php if(auth()->user()->isAdmin() || auth()->user()->isStaff()): ?>
                    <td class="text-end">
                        <button class="btn btn-sm btn-warning" onclick='editWarehouse(<?php echo json_encode($w, 15, 512) ?>)' data-bs-toggle="modal" data-bs-target="#editWarehouseModal">
                            <i class="bi bi-pencil"></i>
                        </button>
                        <form action="<?php echo e(route('warehouses.destroy', $w->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Hapus gudang ini?')">
                            <?php echo csrf_field(); ?>
